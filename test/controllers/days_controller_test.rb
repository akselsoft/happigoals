...
class DaysControllerTest < ActionController::TestCase
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post :create, day: { actions: @day.actions, bad: @day.bad, goal: @day.goal, good: @day.good, regret: @day.regret }
    end
  ...
  test "should update day" do
    patch :update, id: @day, day: { actions: @day.actions, bad: @day.bad, goal: @day.goal, good: @day.good, regret: @day.regret }
    assert_redirected_to day_path(assigns(:day))
  end
